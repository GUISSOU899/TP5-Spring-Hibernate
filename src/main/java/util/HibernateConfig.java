...
@Configuration
@ComponentScan(basePackages = {"com.example", "dao", "entities", "metier", "util"})// ✅ Scanner tous les packages nécessaires
...
public class HibernateConfig {
    ...
    // --- Configuration de la SessionFactory Hibernate ---
    @Bean
    public LocalSessionFactoryBean sessionFactory() {
        LocalSessionFactoryBean sessionFactory = new LocalSessionFactoryBean();
        sessionFactory.setDataSource(dataSource());
        sessionFactory.setPackagesToScan("entities"); // ✅ Scan automatique des entités
